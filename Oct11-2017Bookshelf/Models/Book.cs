...
namespace Oct11_2017Bookshelf.Models
{
    public class Book
    {
        ...
        [ForeignKey("Author2")]
        public int? Author2ID { get; set; } //IMPORTANT this ? allows the foreign key to be null
            //IMPORTANT we need this because we're trying to add data that doesn't exist yet
            //it's OK if the data is there, the ? makes it optional
